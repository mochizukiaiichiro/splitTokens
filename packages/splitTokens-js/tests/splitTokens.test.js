...
import single from '../../../common/test-fixtures/single.json' with { type: 'json' };
import singleDefault from '../../../common/test-fixtures/singleDefault.json' with { type: 'json' };
import oneLine from '../../../common/test-fixtures/oneLine.json' with { type: 'json' };
import multiLines from '../../../common/test-fixtures/multiLines.json' with { type: 'json' };
import misc from '../../../common/test-fixtures/misc.json' with { type: 'json' };
